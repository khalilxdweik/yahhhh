var size = 0;
var placement = 'point';
function categories_test_1(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                var valueStr = (value !== null && value !== undefined) ? value.toString() : 'default';
                switch(valueStr) {case 'Toilet':
...
case 'Religious Building':
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    break;
case 'Special Architectural Building':
                    return [ new ol.style.Style({
        image: new ol.style.Circle({radius: 4.0 + size,
...
var style_test_1 = function(feature, resolution){
    ...
    var style = categories_test_1(feature, value, size, resolution, labelText,
